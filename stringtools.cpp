...
string StringTools::newCleanString(string line){
   // removes initial whitespace, blank, tab, comma, etc. to find actual
   // beginning of string then finds the end by searching for 'end of line' or '#' 
   // truncates the line if delimiter (eol, #) is more than 150 characters from
   // start of string.  Returns a modified string with the leading whitespace and
