...
OBJECTS = interp.o gstring.o main.o pTable.o stringtools.o qchem.o utils.o eckart.o mem.o mem2.o bmat.o print.o print2.o icoord.o mm_grad.o optic.o mopac.o grad.o knnr.o ase.o gaussian.o orca.o molpro.o qchemsf.o 
...
interp.o: interp.cpp interp.h stringtools.h pTable.h icoord.h
mem.o: mem.cpp icoord.h qchem.h
mem2.o: mem2.cpp interp.h
